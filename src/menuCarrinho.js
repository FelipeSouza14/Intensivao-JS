...
<article class="flex bg-slate-100 rounded-lg p-1 relative">
    <button id="fechar-carrinha" class="absolute top-0 right-2">
        <i class="fa-solid fa-circle-xmark text-slate-500 hover:text-slate-800">
        </i></button>
    <img src="./assets/img/product-1.jpg" alt="Camisa larga com bolsos" class="h-24">
    <div class="py-2">
        <p class="text-slate-900">Camisa largo com bolsos</p>
        <p class="text-slate-400">Tamanho: M</p>
        <p class="text-green-400">$70</p>
    </div>
</article>`;
